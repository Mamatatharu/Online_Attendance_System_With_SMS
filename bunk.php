 		...
 		<div class="row">
 			<div class="col-lg-12 "> -->
 			 <div class="col-lg-12 float-right">
 			 			<form name="signup" id="signup" action="mysqltocsv.php" method="post" >
 								<input type="submit" name="fill" id="fill" class="btn btn-success btn-block" style="margin-left:1000px;margin-top:30px;padding: 8px;width: 180px;" value="Send Message">
 				</form>
 				
 			   </div>		
          <h2 style="text-align: center;text-decoration:underline;margin-top:5px; margin-left: 40px;" >Absent List</h2>
