...
<a style="color:white;" href="register.php"><button class="btn btn-success "style="margin-top:25px;margin-left:38%;width:25%;">Add</button></a>
 			...
 			<div class="col-lg-12 ">
 				<h3 style="text-align:center;margin-top:10px;">Electrical Record List</h3>
 				<hr>
    ...
    <tbody id="tbl">
    	<?php
                 $query = "SELECT * FROM register WHERE Course='Electrical'";
      ...
      <tr>
        ...
        <td><a  href="<?php $_SERVER['PHP_SELF'] ?>?del=<?php echo $users['Id'] ?>" 
           ...
           <a  href="Elecreg.php?upd=<?php echo $users['Id'] ?>" 
